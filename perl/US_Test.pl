...
$req = GET 
	...
	'http://rest3api.sifassociation.org/api/solutions/auTestSolution/requestsConnector/StudentPersonals/',
	Content_Type => 'application/xml',
	Accept => 'application/xml',
;
